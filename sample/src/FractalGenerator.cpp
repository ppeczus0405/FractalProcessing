...
PekiProc::FractalAlgorithmType FractalGenerator::fractalStringToType(
    const std::string& fractal_type) {
  if (fractal_type == "Mandelbrot")
    return PekiProc::FractalAlgorithmType::MANDELBROT;
  if (fractal_type == "Multibrot")
    return PekiProc::FractalAlgorithmType::MULTIBROT;
  if (fractal_type == "Julia")
    return PekiProc::FractalAlgorithmType::JULIA;
  if (fractal_type == "PolyJulia")
    return PekiProc::FractalAlgorithmType::POLYJULIA;
  if (fractal_type == "Newton")
    return PekiProc::FractalAlgorithmType::NEWTON;
  if (fractal_type == "Nova")
    return PekiProc::FractalAlgorithmType::NOVA;
...
bool FractalGenerator::zoom(std::pair<int, int> v1, std::pair<int, int> v2) {
